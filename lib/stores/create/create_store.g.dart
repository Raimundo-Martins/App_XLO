...
mixin _$CreateStore on _CreateStoreBase, Store {
  ...
  final _$savedAdvertsAtom = Atom(name: '_CreateStoreBase.savedAdverts');

  @override
  bool get savedAdverts {
    _$savedAdvertsAtom.reportRead();
    return super.savedAdverts;
  }

  @override
  set savedAdverts(bool value) {
    _$savedAdvertsAtom.reportWrite(value, super.savedAdverts, () {
      super.savedAdverts = value;
    });
  }
